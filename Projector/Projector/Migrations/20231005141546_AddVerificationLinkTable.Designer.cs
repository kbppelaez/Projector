...
namespace Projector.Migrations
{
    ...
    [Migration("20231005141546_AddVerificationLinkTable")]
    partial class AddVerificationLinkTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projector.Data.VerificationLink", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projector.Data.VerificationLink", b =>
                {
                    b.HasOne("Projector.Data.User", "User")
                        .WithOne("VerificationLink")
                        .HasForeignKey("Projector.Data.VerificationLink", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
